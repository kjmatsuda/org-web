...
const ActionDrawer = ({
  ...
  const handleUpClick = () =>
    !!selectedHeaderId ? org.moveHeaderUp(selectedHeaderId) : (!!selectedTableCellId ? org.moveTableRowUp() : org.moveListItemUp());

  const handleDownClick = () =>
    !!selectedHeaderId ? org.moveHeaderDown(selectedHeaderId) : (!!selectedTableCellId ? org.moveTableRowDown() : org.moveListItemDown());

  const handleLeftClick = () =>
    !!selectedHeaderId ? org.moveHeaderLeft(selectedHeaderId) : (!!selectedTableCellId ? org.moveTableColumnLeft() : org.moveListItemLeft());

  const handleRightClick = () =>
    !!selectedHeaderId ? org.moveHeaderRight(selectedHeaderId) : (!!selectedTableCellId ? org.moveTableColumnRight() : org.moveListItemRight());
